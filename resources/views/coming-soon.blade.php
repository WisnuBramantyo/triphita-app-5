...
<html lang="en">
<head>
    <title>Triphita - Coming Soon</title>
    <meta charset="utf-8">
    ...
    <style>
        ...
        .coming-soon-content {
            ...
            padding: 2rem;
            padding-bottom: 6rem; /* ✅ Tambahan ini */
            position: relative;
        }
        .coming-soon h1 {
            font-size: 4rem;
...
<body>
    ...
    <section class="coming-soon">
        <div class="coming-soon-content">
            <h1>Coming Soon</h1>
            <p>We're working on something amazing for your experiences!</p>
            <p>Meanwhile, you can find some interesting stays!</p>
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="ftco-search">
                            <!-- <style>
                              ...
                              <div
                                ...
                                data-search-page-url='/activities'
